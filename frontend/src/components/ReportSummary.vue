<template>
    <v-row>
      <v-col>
        <h1 class="display-1"> Report Dashboard </h1>
      </v-col>
    </v-row>
    <v-row>
      <v-col cols="12">
        <v-card elevation="4" class="m-4">
          <v-card-title class="bg-secondary"> {{ props.reportData.date }} </v-card-title>
          <v-divider></v-divider>
          <v-row>
            <v-col>
    ...
    <v-row>
      <v-col cols="12">
        <v-expansion-panels variant="accordion">
          <v-expansion-panel v-for="(suite, index) in props.suiteData" :key="index">
            ...
            <v-expansion-panel-text>
              <v-expansion-panels variant="accordion">
                <v-expansion-panel v-for="(test, index) in suite.TestCases" :key="index">
